/**
 * Cenário 6 - Homologação WOOBA
 * 2 Adultos, 1 Criança e 1 Bebê | Ida e volta | Nacional SAO x RIO | Pagamento faturado
 *
...
const OUT_DIR = path.join(__dirname, 'cenario6-2adultos-crianca-bebe-idavolta-nacional-faturado')
...
;(async () => {
  ...
  console.log('=== Cenário 6: 2 Adultos + 1 Criança + 1 Bebê | Ida e volta | Nacional | Faturado ===')
  ...
  const disponibilidade = await chamar(2, 'Disponibilidade', {
    ...
    QuantidadeAdultos: 2, QuantidadeCriancas: 1, QuantidadeBebes: 0,
    QuantidadeDeVoos: 10,
  ...
  const reserva  = await chamar(4, 'Reservar', {
    ...
    ClassesSelecionadasVolta: classesSelecionadasVolta,
    Passageiros: [
      { Nome: ADULTO1.Nome,  Sobrenome: ADULTO1.Sobrenome,  CPF: ADULTO1.CPF,
        Nascimento: ADULTO1.Nascimento,  Email: ADULTO1.Email,
        FaixaEtaria: ADULTO1.FaixaEtaria,  Sexo: ADULTO1.Sexo,  Linha: '1' },
      { Nome: ADULTO2.Nome,  Sobrenome: ADULTO2.Sobrenome,  CPF: ADULTO2.CPF,
        Nascimento: ADULTO2.Nascimento,  Email: ADULTO2.Email,
        FaixaEtaria: ADULTO2.FaixaEtaria,  Sexo: ADULTO2.Sexo,  Linha: '2' },
      { Nome: CRIANCA.Nome,  Sobrenome: CRIANCA.Sobrenome,  CPF: CRIANCA.CPF,
        Nascimento: CRIANCA.Nascimento,  Email: CRIANCA.Email,
        FaixaEtaria: CRIANCA.FaixaEtaria,  Sexo: CRIANCA.Sexo,  Linha: '3' },
    ],
    InformacoesComplementaresPassageiro: [
      { Nome: ADULTO1.Nome,  Sobrenome: ADULTO1.Sobrenome,  Tipo: 'ADT' },
      { Nome: ADULTO2.Nome,  Sobrenome: ADULTO2.Sobrenome,  Tipo: 'ADT' },
      { Nome: CRIANCA.Nome,  Sobrenome: CRIANCA.Sobrenome,  Tipo: 'CHD' },
    ],
    Contatos: [
      { Nome: `${ADULTO1.Nome} ${ADULTO1.Sobrenome}`, Email: ADULTO1.Email,
        NumeroDDD: '11', NumeroTelefone: '999999999', NumeroDDI: '55', Tipo: 0 },
    ],
    Solicitante: ADULTO1.Nome,
  ...
  if (numeroEticket) {
    await chamar(9, 'ConsultarEticket', {
      Login: LOGIN, Senha: SENHA, Eticket: numeroEticket, Sistema: sistema.Sistema,
  ...
  console.log('\n✅ Cenário 6 concluído. Arquivos salvos em:')
  console.log(`   ${OUT_DIR}`)
})().catch(err => {
