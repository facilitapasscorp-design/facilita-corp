            ...
            <div className="px-6 py-5">
              {chamadoEnviado ? (
                <div className="text-center py-4">
                  ...
                  <p className="font-semibold text-gray-900 mb-1">Solicitação registrada!</p>
                  <p className="text-sm text-gray-500 mb-5">
                    Já está na fila da nossa equipe. Se for urgente, chame no WhatsApp
                    que a gente resolve na hora.
                  </p>
                  <a
                    href={linkWhatsApp(
                      `Olá! Acabei de abrir uma solicitação de ${chamadoTipo} no sistema.\n` +
                      `Localizador: ${chamadoReserva.localizador}\n` +
                      `Trecho: ${chamadoReserva.origem} para ${chamadoReserva.destino}\n\n` +
                      chamadoMensagem,
                    )}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-sm font-semibold text-white hover:opacity-90 transition-opacity mb-2"
